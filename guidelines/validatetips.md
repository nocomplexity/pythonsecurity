...
Use this checklist to carry out a risk assessment before adopting any **security application** developed in Python. 

:::{important}
Security applications have higher and more stringent quality requirements than standard Python applications.

Before deploying any Python-based security tool, you must work through this checklist.

:::


It is designed to help identify potential weaknesses, evaluate code quality, and ensure the project meets minimal essential security standards. Applying this checklist consistently will support informed decision-making and reduce the risk of introducing security weaknesses into your environment.
